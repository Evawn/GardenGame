...
let make_spec_seed spec =
  match spec with
  | Poppy -> make_seed Poppy 10 20
  | Coca -> make_seed Coca 10 20
  | Sassafras -> make_seed Sassafras 10 20
  | Marigold -> make_seed Marigold 10 20
  | Petunia -> make_seed Petunia 10 20
